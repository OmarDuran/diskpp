...
//        f.m_er_index = end_point_mortars[1].second;//mesh_builder.fracture_nodes()[1].second;
    ...
    if(0){
        ...
        f0.m_el_index = 7;
        f0.m_br_index = 6;
        f0.m_er_index = 38;//1062;//667;//199;//38;//449
        f0.build(msh);
        ...
        f1.m_bl_index = 4;
        f1.m_el_index = 7;
        f1.m_br_index = 46;//1138;//719;//219;//46;//472
        f1.m_er_index = 47;//1131;//716;//222;//47;//475
        f1.build(msh);
        f1.m_bc_type = {1,1};
        ...
        f2.m_pairs = f2_pairs;
        f2.m_bl_index = 5;
        f2.m_el_index = 47;//1131;//716;//222;//47;//475
        f2.m_br_index = 42;//1078;//684;//214;//42;//455
        f2.m_er_index = 38;//1062;//667;//199;//38;//449
        f2.build(msh);
        f2.m_bc_type = {1,1};
...
//                    std::cout << st_r_dof << std::endl;
        ...
        if(1){
            ...
            size_t n_mortar_displacements = 2 * restrictions.size();
