...
//                scatter_mortar_skin_n_data(msh,chunk.second,fracture_ind,1,mortar_r.first);
            ...
            scatter_mortar_skin_t_sigma_data(msh,chunk.first,fracture_ind,0,mortar_l.first);
//            scatter_mortar_skin_n_sigma_data(msh,chunk.first,fracture_ind,0,mortar_l.second);
            
            mortar_r.first  *= -1.0;
            mortar_r.second *= -1.0;
//            scatter_mortar_skin_t_sigma_data(msh,chunk.second,fracture_ind,1,mortar_r.first);
            scatter_mortar_skin_n_sigma_data(msh,chunk.second,fracture_ind,1,mortar_r.second);
